...
# 探索実行: zig build fuzz --fuzz --webui=127.0.0.1
# 時間制限とコーパスについては docs/design/pbt-strategy.md §6-4 を参照。
...
- Zig 0.16.0 or later（定義の真は `build.zig.zon` の `minimum_zig_version`。更新手順は `docs/maintenance.md`）
