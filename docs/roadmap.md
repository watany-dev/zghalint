...
| 4 | #410 / #411（AF7 / AF8） | autofix 第 2 波の P1 のうち安全側の 2 本。EXPR002〜EXPR004 の did-you-mean は AF1 の `rename` と EXPR006 の式バイトオフセットで、ACT001 の `shell:` 挿入は BP004 の `shell_insertion_byte` でそのまま閉じる。通常 lint の壁時間と RSS を動かさない |
