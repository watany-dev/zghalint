...
オープンな PR / issue を main（`d9573a0`）の実装状況と突き合わせ、以後の実施順序を示す。
...
CI と PBT の両方から回るようになった。ドッグフーディングは D1〜D5 を片付けた後、新たに D6 / D7（#372 / #375）を出しており、PR #378 で `doghooding` スキルとして手順が固定された。
